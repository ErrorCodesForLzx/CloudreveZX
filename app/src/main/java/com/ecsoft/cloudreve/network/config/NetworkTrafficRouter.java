...
public class NetworkTrafficRouter {
    ...
    public static final String network_tell_upload_file       = "/api/v3/file/upload"; // PUT METHOD;
    public static final String network_upload_file            = "/api/v3/file/upload/#{sessionId}/#{chunkIndex}"; // POST METHOD;
    public static final String network_rename_file            = "/api/v3/object/rename";
