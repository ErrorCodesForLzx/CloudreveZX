...
public class OpenScreenActivity extends AppCompatActivity {
    ...
    private void initWebCore(){
        ...
        // QbSdk.installLocalTbsCore(OpenScreenActivity.this,46141,"");
        QbSdk.initX5Environment(OpenScreenActivity.this, new QbSdk.PreInitCallback() {
            @Override
            ...
            public void onViewInitFinished(boolean b) {
                if (!b){
                    Toast.makeText(OpenScreenActivity.this, "文件浏览X5核心初始化失败，切换到系统内核", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
